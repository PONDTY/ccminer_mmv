...
Mobile Mining 2.4(Original ccminer)                 "Verushash"
---------------------------------------------------------------
...
phumin-dev(mobile_mining version):
  DOGE : DFwUqKS3j3RMMkqQF8z6kbYZ652M8VCFVs
  

tpruvot@github(original developer version):
  BTC  : 1AJdfCpLWPNoAMDfHF1wD5y8VgKSSTHxPo
  DCR  : DsUCcACGcyP8McNMRXQwbtpDxaVUYLDQDeU

DJM34(original developer version):
  BTC donation address: 1NENYmxwZGHsKFmyjTc5WferTn5VTFb7Ze

cbuchner v1.2(original developer version):
...
With kind regards,
   ...
   Phumin-dev ( github.com/mantvmass )
