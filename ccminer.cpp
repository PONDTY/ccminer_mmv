 ...
 *  [ Correcttion details ]
 *  - Developed by phumin-dev [ Development start date 30/06/2021 ].
 *  - Can only mine veruscoin.
 *  - Fix old mobile CPU to be able to mine.
 *  - Reduce file  size by removing unnecessary source code and other files.
...
#define PROGRAM_NAME		"Mobile Mining"
